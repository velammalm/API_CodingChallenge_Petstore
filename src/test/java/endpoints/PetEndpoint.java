...
public class PetEndpoint extends BaseEndpoints {
	...
	public void addPet(Base base) {
		base.setRequest(getRequestWithJSONHeaders());
		base.setResponse(addPet(base.getRequest()));
	}
	
	public void addPet(Base base, Pet pet) {
		base.setPet(pet);
		base.setRequest(getRequestWithJSONHeaders());
		base.setResponse(addPet(base.getRequest(), pet));
	}
